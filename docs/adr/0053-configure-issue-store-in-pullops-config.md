...
PullOps Init should install repo-local issue tracker instructions that describe PullOps as the issue tracker from upstream skills' perspective and route Spec, Ticket, and Concrete Issue publication through `pullops issues ...` commands.
