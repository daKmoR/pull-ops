 ...
 * @returns {string}
 */
export function buildFixCiPrompt({ pullRequest, issue, reviewContext, diff, checkFailures }) {
  return [
    'Use the pullops-fix-ci skill.',
    '',
...
function formatIssue(issue) {
  if (issue === undefined) {
    return '(none supplied; this is an explicit manual fix-ci request for a pull request)';
  }
