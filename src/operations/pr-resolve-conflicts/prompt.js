...
export function buildPrResolveConflictsPrompt({
  ...
  return [
    ...
    '',
    `Resolve rebase conflicts for PR #${pullRequest.number}: ${pullRequest.title}`,
    '',
    ...
    '',
    'Constraints:',
    '- Edit the real conflicted files in this checkout; do not describe a patch without applying it.',
